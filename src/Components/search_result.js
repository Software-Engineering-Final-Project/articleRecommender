...
export function SubSearchResult(props) {
    const addIcon = <FontAwesomeIcon icon={['fa', 'plus']} size='sm' />
    return(
        <div className='container mt-3' id='search-row'>
            <div className='row justify-content-center p-2'>
            ...
            <div className='row p-2 justify-content-between'>
                ...
                <button 
                    type="button" 
                    onClick={() => props.onClick(props.sub_id, props.parent_id)} 
                    className={`btn btn-outline-success btn-sm`}>{addIcon}
                </button>
                </div>
                <div className='flex-col-6'>
                <button 
                    type="button" 
                    onClick={() => props.onClick2(props.sub_id)} 
                    className={`btn btn-outline-secondary btn-sm`}>More Info
                </button>
                </div>
                </div>
...
export default {SearchResult, SubSearchResult}